...
const Navbar =()=>{
    ...
    return(
        <nav className="fixed top-4 z-50 flex w-full flex-col items-center justify-center">
            <div className="flex w-full items-center justify-between overflow-y-hidden p-6  lg:m-2 lg:w=[50rem] lg:rounded-full">
                <img src={logo} alt="Logo" width={95} height={22} className="pr-4 cursor-pointer"/>
                <div className="flex w-6xl">
                    <div className="hidden uppercase space-x-6 lg:flex">
                        {LINKS.map((link,idx)=>(
